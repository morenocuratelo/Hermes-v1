...
class TestHermesLogic(unittest.TestCase):
    ...
    def test_03_entity_logic(self):
        ...
        try:
            from hermes_entity import IdentityLogic, HistoryManager
            ...
            logic.tracks = {1: {'frames': [0, 1], 'boxes': [[0,0,10,10], [1,1,11,11]], 'role': 'Ignore', 'merged_from': [1]}}
    ...
    def test_04_region_logic(self):
        ...
        try:
            from hermes_region import RegionLogic, AOIProfileManager
            logic = RegionLogic()
