...
class ReviewerView:
    ...
    def _add_file_picker(self, parent, label, var, callback, filetypes):
        ...
        ttk.Button(
            ...
            text="📂",
            width=3,
            command=lambda: self._browse(var, callback, filetypes),
    ...
    def show_frame(self):
        ...
        if self.logic.df_tois is not None:
            matches = self.logic.df_tois[
                (self.logic.df_tois["Start"] <= curr_sec) & (self.logic.df_tois["End"] >= curr_sec)
            ]
